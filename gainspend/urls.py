...
urlpatterns = [
    ...
    # path('preface_runge_kutta_tercer_orden/',views.preface_preface_runge_kutta_tercer_orden, name='preface_preface_runge_kutta_tercer_orden'),
    # path('preface_runge_kutta_tercer_orden/excercise',views.excercise_preface_runge_kutta_tercer_orden, name='excercise_preface_runge_kutta_tercer_orden'),
