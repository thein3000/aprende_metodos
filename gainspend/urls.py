...
urlpatterns = [
    ...
    path('preface_regla_trapezoidal/',views.preface_regla_trapezoidal, name='preface_regla_trapezoidal'),
    path('preface_regla_trapezoidal/excercise',views.excercise_regla_trapezoidal, name='excercise_regla_trapezoidal'),
