...
from gainspend.metodos_numericos import cuadratica_con_funcion
...
def preface_cuadratica_con_funcion(request):
    ...
    return render(request, 'gainspend/pages/preface_cuadratica_con_funcion.html', context)
...
def excercise_cuadratica_con_funcion(request):
    ...
    while invalid:
        try:
            ...
            y_print = var_value(y)
            funcion_print = var_value(funcion)
            lista_coeficientes = cuadratica_con_funcion.metodo_cuadratica_con_funcion(x,y,funcion)
            invalid = False
        except Exception as e:
            print(e)
            invalid = True
    ...
    return render(request, 'gainspend/pages/excercise_cuadratica_con_funcion.html', context)
